...
struct _Main{
//////////////
string dataName = "groxfst";
string stdName = "groxfst";
...
void make(){
	...
	for(I=beg;I<end;I++){
		...
		if (I == 0) {
			cout << 1004535809 << endl;
			cout << lrand(1, 100000) << endl;
			cout << lrand(1, 1000) << endl;
			cout << lrand(1, 1004535807) << endl;
		} else
		if (I == 1) {
			cout << lrand(1, 1004535807) << endl;
			cout << lrand(1, 100000) << endl;
			cout << lrand(1, 1000) << endl;
			cout << 1004535808 << endl;			
		} else
		if (I == 2) {
			cout << 1004535810 << endl;
			cout << lrand(1, 100000) << endl;
			cout << lrand(1, 1000) << endl;			
			cout << 1004535810 << endl;
		} else 
		...
		if (I == 4) {
			cout << lrand(1, 10) << endl;
			cout << lrand(1, 10) << endl;
			cout << lrand(1, 10) << endl;
			cout << lrand(1, 10) << endl;
		} else if (I == 5) {
			cout << 1004535808 << endl;
			cout << 100000 - lrand(100, 195) << endl;
			cout << 1000 - lrand(10, 95) << endl;
			cout << 1004535807 << endl;
		} 
		else
		if (I < 10) {
			int len = lrand(1, 1000);
			for (int i = 1; i <= len; i++) {
				if (i == 1) cout << lrand(1, 9);
				else cout << lrand(0, 9);
			}
			cout << endl;
			cout << lrand(1, 100000) << endl;
