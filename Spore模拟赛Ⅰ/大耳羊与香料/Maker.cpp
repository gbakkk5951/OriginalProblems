...
void make(){
	...
	for(I=beg;I<end;I++){
		...
		if (I >> 1 == 0) {
			...
			an = lrand(5000, 30000);
			bn = 2;			
			mchain(1, 30001, n, cout);
			mflower(1, 2, 15000, cout);
			mflower(n, 15001, 30000, cout);
			cout << an << endl;
			for (int i = 1; i <= an; i++) {
				cout << lrand(2, n - 1) << sp;
			}
			...
			an = lrand(5000, 30000);
			bn = 2;			
			mchain(1, 70001, 100000, cout);
			mflower(1, 2, 15000, cout);
			mflower(n, 15001, 30000, cout);
			mtree(1, 30001, 70000, cout);
			cout << an << endl;
			for (int i = 1; i <= an; i++) {
				cout << lrand(2, n - 1) << sp;
			}
			...
			an = lrand(5000, 30000);
			bn = 2;			
			mchain(1, 30001, 50000, cout);
			mflower(1, 2, 15000, cout);
			mflower(n, 15001, 30000, cout);
			mtree(1, 50001, 99999, cout);
			add(50000, n, cout);
			cout << an << endl;
			for (int i = 1; i <= an; i++) {
				if (rand() & 1) {
					cout << lrand(2, 30000) << sp;
				} else {
					cout << lrand(50001, 99999) << sp;
				}
			}
			cout << endl << bn << endl;
			cout << 1 << sp << n << endl;	
			...
			an = lrand(5000, 30000);
			bn = 2;			
			mchain(1, 30001, 70000, cout);
			mbtree(1, 2, 15000, cout);
			mbtree(n, 15001, 30000, cout);
			mtree(1, 70001, 99999, cout);
			add(70000, 100000, cout);
			cout << an << endl;
			for (int i = 1; i <= an; i++) {
				if (rand() & 1) {
					cout << lrand(2, 30000) << sp;
				} else {
					cout << lrand(70001, 99999) << sp;
				}
			}
			cout << endl << bn << endl;
			cout << 1 << sp << n << endl;		
			...
			mbtree(1, 2, 15000, cout);
			mbtree(n, 15001, 30000, cout);
			mbtree(30050, 70001, 79999, cout);
			mflower(69950, 80000, 89999, cout);
			mtree(30001, 90000, 99999, cout);
			add(70000, 100000, cout);
			cout << an << endl;
			for (int i = 1; i <= an; i++) {
				if (rand() & 1) {
